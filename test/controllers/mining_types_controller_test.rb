...
class MiningTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mining_type" do
    assert_difference('MiningType.count') do
      post mining_types_url, params: { mining_type: { name: @mining_type.name, title: @mining_type.title } }
    end
  ...
  test "should update mining_type" do
    patch mining_type_url(@mining_type), params: { mining_type: { name: @mining_type.name, title: @mining_type.title } }
